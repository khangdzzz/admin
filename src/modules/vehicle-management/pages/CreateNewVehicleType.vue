<template>
    <div class="create-new-vehicle-type-form">
        <a-card :bordered="false">
            <h3 class="create-new-vehicle-type-form__title">Add new vehicle type</h3>
            <a-form :model="dynamicValidateForm" name="basic" autocomplete="off">
                ...
                <div class="create-new-vehicle-type-form__action">
                    ...
                    <a-button type="primary" class="create-new-vehicle-type-form__action--submit" html-type="submit"

                  ...
                  <div v-show="!collapsed">
                    ...
                    >
                      <a-menu-item
                        ...
                        v-if="
                          isHasPermission(subMenuItem.requireUserType) &&
                      ...
                      <a-menu-item
                        :key="subMenuItem.pathName"
                        class="default-layout__category"
                        :disabled="true"
                        v-if="
                          isHasPermission(subMenuItem.requireUserType) &&
                          subMenuItem.category
                      ...
                      <span
                        v-for="secondSubMenu in subMenuItem?.items"
                        :key="secondSubMenu.title"
                      >
                        <a-menu-item
                          :key="secondSubMenu.pathName"
                          v-if="isHasPermission(secondSubMenu.requireUserType)"
                        >
                          <router-link :to="{ name: secondSubMenu.pathName }">
                            <span
                              class="default-layout__sub-menu-title"
                              v-if="$t"
                              :id="secondSubMenu.qaAttr"
                            >
                              {{ $t(secondSubMenu.title) }}
                            </span>
                          </router-link>
                        </a-menu-item>
                      </span>
